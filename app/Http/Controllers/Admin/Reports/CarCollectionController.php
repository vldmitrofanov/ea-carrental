...
class CarCollectionController extends Controller
{
    /**
    ...
    {    
        return view('admin.reports.collection');
    }
    ...
    public function report(Request $request){
        ...
        if(trim($searchStr)!=''){
            $total = CarReservation::
                ...
                ->whereRaw('DATE_FORMAT(`car_reservation_details`.`date_to`, "%Y-%m-%d") between  "'.$start_date.'"  AND  "'.$end_date.'" ')
