    ...
    <div>
        <div class="panel-body">
            ...
            <div class="form-group">
                <input required type='text' class="form-control date" id='start' name="start" placeholder="Start Date" />
            </div>
            <div class="form-group">
                <input required type='text' class="form-control date" id='end' name="end" placeholder="End Date" />
            </div>
            <div class="form-group">
