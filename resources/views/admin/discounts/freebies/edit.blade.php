...
@section('title')
    Freebies Discount Management | Add New
@endsection
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    {!! Form::model($oDiscount, array('url' =>array('admin/discounts/freebies/update', $oDiscount->id), 'id' => 'vouchers', 'method' => 'PATCH', 'enctype'=>'multipart/form-data', 'class' => 'form-horizontal')) !!}
                    <input type="hidden" name="voucher" id="voucher" value="{{ $oDiscount->id}}">
                    @include('admin.discounts.freebies.forms.edit', ['submit_button'=>'Submit'])
                </div>
            </div>
        </section>
    </div>
