...
<head>
    ...
    <title>Embassy Alliance Admin | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('administration/plugins/iCheck/square/blue.css') }}">
...
<script src="{{ asset('administration/plugins/iCheck/icheck.min.js') }}"></script>
</body>
</html>
